                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-3">
                                ...
                                <a href="mailto:kumkumsahu1505@gmail.com" target="_blank">lokeshyadav5030@gmail.com</a>
                            </div>
                            <div className="flex items-center gap-3">
                        ...
                        <div className="flex gap-4 mt-6">
                            <a
                                href="https://github.com/34lokeshyadav"
                                target="_blank"
                            ...
                            <a
                                href="https://www.linkedin.com/in/lokesh-yadav-27636a260/"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="GitHub"
